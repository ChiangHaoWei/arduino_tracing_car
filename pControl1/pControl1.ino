...
void tracking(){
  ...
  double error = 1*l3 + 0.5*l2 + 0.3*l1 - 0.8*(l3 == l2 && l3==1)- 0.5*(l1 == l2 && l1==1)- 0.3*(l1 == 1 && l2==0)
                 -(1*r3 + 0.5*r2 - 0.3*r1 - 0.8*(r3 == r2 && r3==1)-0.5*(r1 == r2 && r1==1)-0.3*(r1 == 1 && r2==0)) ;
  double vR = 60 + 75*error;
